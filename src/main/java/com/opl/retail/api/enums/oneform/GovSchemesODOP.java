...
public enum GovSchemesODOP {
    ...
    GovSchemesODOP(Integer id, String value, String description) {
        this.id = id;
        this.value = value;
    ...
    public static GovSchemesODOP getById(Integer id) {
        switch (id) {
            case 1:
    ...
    public static GovSchemesODOP[] getAll() {
        return GovSchemesODOP.values();
    }
