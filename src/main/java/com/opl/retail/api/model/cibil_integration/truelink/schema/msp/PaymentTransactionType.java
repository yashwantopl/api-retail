...
import com.opl.retail.api.model.cibil_integration.truelink.schema.database.tcps.enumerations.PaymentProcessorType;
import com.opl.retail.api.model.cibil_integration.truelink.schema.database.tcps.enumerations.PaymentTransStatusType;
...
public class PaymentTransactionType {
    ...
    @XmlSchemaType(name = "string")
    protected com.opl.retail.api.model.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType creditCardType;
    @XmlElement(name = "CreditCard", required = true)
    protected com.opl.retail.api.model.cibil_integration.truelink.schema.msp.CreditCardType creditCard;
     ...
     * @return
     *     possible object is
     *     {@link com.opl.retail.api.model.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType }
     *     
     */
    public com.opl.retail.api.model.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType getCreditCardType() {
     ...
     *     
     */
    public void setCreditCardType(com.opl.retail.api.model.cibil_integration.truelink.schema.database.tcps.enumerations.CreditCardType value) {
     ...
     * @return
     *     possible object is
     *     {@link com.opl.retail.api.model.cibil_integration.truelink.schema.msp.CreditCardType }
     *     
     */
    public com.opl.retail.api.model.cibil_integration.truelink.schema.msp.CreditCardType getCreditCard() {
        return creditCard;
    }
     ...
     *     
     */
    public void setCreditCard(com.opl.retail.api.model.cibil_integration.truelink.schema.msp.CreditCardType value) {
