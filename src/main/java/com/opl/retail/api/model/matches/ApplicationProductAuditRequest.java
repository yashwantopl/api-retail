...
public class ApplicationProductAuditRequest implements Serializable{
	...
	/**
	 * @return the consessionRoiConcessPf
	 */
	...
	/**
	 * @return the pfConcessionTextConcessPf
	 */
	...
	/**
	 * @param consessionRoiConcessPf the consessionRoiConcessPf to set
	 */
	...
	/**
	 * @param pfConcessionTextConcessPf the pfConcessionTextConcessPf to set
	 */
