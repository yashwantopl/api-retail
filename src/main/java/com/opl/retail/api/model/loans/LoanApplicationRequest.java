...
public class LoanApplicationRequest implements Serializable {
	...
	public void setDealerTypeId(Integer dealerTypeId) {
		this.connectFlowTypeId = dealerTypeId;
	}
	...
	public String toString() {
		return "LoanApplicationRequest{" +
				...
				", loanTypeMain='" + loanTypeMain + '\'' +
				", loanTypeSub='" + loanTypeSub + '\'' +
				", currencyValue='" + currencyValue + '\'' +
				", isApplicantDetailsFilled=" + isApplicantDetailsFilled +
				", isApplicantPrimaryFilled=" + isApplicantPrimaryFilled +
				", isApplicantFinalFilled=" + isApplicantFinalFilled +
				", applicationCode='" + applicationCode + '\'' +
				", status=" + status +
				", primaryFilledCount='" + primaryFilledCount + '\'' +
				", profilePrimaryLocked=" + profilePrimaryLocked +
				", finalLocked=" + finalLocked +
				", mcaCompanyId='" + mcaCompanyId + '\'' +
				", isMca=" + isMca +
				", npUserId=" + npUserId +
				", npAssigneeId=" + npAssigneeId +
				", fpMakerId=" + fpMakerId +
				", email='" + email + '\'' +
				", mobile='" + mobile + '\'' +
				", userName='" + userName + '\'' +
				...
				", isNhbsApplication=" + isNhbsApplication +
				", ddrStatusId=" + ddrStatusId +
				", gstIn='" + gstIn + '\'' +
				", npOrgId=" + npOrgId +
				", onlinePaymentSuccess=" + onlinePaymentSuccess +
				", fsNameForPayment='" + fsNameForPayment + '\'' +
				", amountForPayment='" + amountForPayment + '\'' +
				", roiForPayment='" + roiForPayment + '\'' +
				", tenureForPayment='" + tenureForPayment + '\'' +
				", emiForPaymentayment='" + emiForPaymentayment + '\'' +
				", feesForPayment='" + feesForPayment + '\'' +
				", fpNameForPayment='" + fpNameForPayment + '\'' +
				", proposalId=" + proposalId +
				", businessTypeId=" + businessTypeId +
				", applicationStatus='" + applicationStatus + '\'' +
				", wcRenewalStatus=" + wcRenewalStatus +
				", isMcqSkipped=" + isMcqSkipped +
