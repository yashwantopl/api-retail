package com.opl.retail.api.model.loans.score;
...
public class ScoringRequestLoans {
	...
	public String toString() {
		return "ScoringRequestLoans [fsDigit=" + fsDigit + ", fpProductId=" + fpProductId + ", loanPurposeModelId="
				+ loanPurposeModelId + ", coApplicantId=" + coApplicantId + ", isConsiderCoAppIncome="
				+ isConsiderCoAppIncome + ", orgId=" + orgId + ", scoringModelId=" + scoringModelId
				+ ", scoringModelCoAppId=" + scoringModelCoAppId + ", applicationId=" + applicationId
				+ ", financialTypeIdProduct=" + financialTypeIdProduct + ", emi=" + emi + ", roi=" + roi + ", userId="
				+ userId + ", tenureFS=" + tenureFS + ", elAmountBasedOnIncome=" + elAmountBasedOnIncome
				+ ", elAmountOnAverageScoring=" + elAmountOnAverageScoring + ", tenureScoring=" + tenureScoring
				+ ", ageFS=" + ageFS + ", tenureFP=" + tenureFP + ", incomeType=" + incomeType + ", nmi=" + nmi
				+ ", gmi=" + gmi + ", foir=" + foir + ", foirInRs=" + foirInRs + ", coAppIncomeArray="
				+ coAppIncomeArray + ", coApp1Income=" + coApp1Income + ", coApp2Income=" + coApp2Income
				+ ", coApp3Income=" + coApp3Income + ", isConsiderCoApp=" + isConsiderCoApp + ", isSetGrossNetIncome="
				+ isSetGrossNetIncome + ", employmentType=" + employmentType + ", marketValue=" + marketValue
				+ ", existingObligation=" + existingObligation + ", purCunsExpRepAndRenovCost="
				+ purCunsExpRepAndRenovCost + ", ltvScoring=" + ltvScoring + ", loanAmountBorrower="
				+ loanAmountBorrower + ", maximumLoanAmountLender=" + maximumLoanAmountLender + ", eligibleTenure="
				+ eligibleTenure + ", timesMultiplier=" + timesMultiplier + ", monthlyObligation=" + monthlyObligation
				+ ", netTakeHomepay=" + netTakeHomepay + ", noOfCoApplicantFP=" + noOfCoApplicantFP
				+ ", noOfCoApplicantFS=" + noOfCoApplicantFS + ", incomeTypeMultiplier=" + incomeTypeMultiplier
				+ ", isSetTimesMultiplierIncome=" + isSetTimesMultiplierIncome + ", isSetLTV=" + isSetLTV
				+ ", isSetPurCunsExpRepAndRenovCost=" + isSetPurCunsExpRepAndRenovCost + ", isSetMarketValue="
				+ isSetMarketValue + ", scoreParameterRequestLoans=" + scoreParameterRequestLoans
				+ ", scoreParameterNTBRequest=" + scoreParameterNTBRequest + ", scoreParameterRetailRequest="
				+ scoreParameterRetailRequest + ", bureauVersion=" + bureauVersion + ", eligibleLoanAmountCircular="
				+ eligibleLoanAmountCircular + ", mapList=" + mapList + ", assetCoverage=" + assetCoverage + "]";
	}
}
