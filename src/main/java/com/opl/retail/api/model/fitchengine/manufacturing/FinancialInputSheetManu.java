...
public class FinancialInputSheetManu
{
		...
		private Double otherManufacturingExpeFy=0.0;
		private Double otherManufacturingExpeSy=0.0;
		private Double otherManufacturingExpeTy=0.0;
		...
		public Double getOtherManufacturingExpeFy() {
			return otherManufacturingExpeFy;
		}
		public void setOtherManufacturingExpeFy(Double otherManufacturingExpeFy) {
			this.otherManufacturingExpeFy = otherManufacturingExpeFy;
		}
		public Double getOtherManufacturingExpeSy() {
			return otherManufacturingExpeSy;
		}
		public void setOtherManufacturingExpeSy(Double otherManufacturingExpeSy) {
			this.otherManufacturingExpeSy = otherManufacturingExpeSy;
		}
		public Double getOtherManufacturingExpeTy() {
			return otherManufacturingExpeTy;
		}
		public void setOtherManufacturingExpeTy(Double otherManufacturingExpeTy) {
			this.otherManufacturingExpeTy = otherManufacturingExpeTy;
		}
		...
		public String toString() {
			return "FinancialInputSheetManu [companyName=" + companyName + ", shareFaceValue=" + shareFaceValue
					...
					+ employeeCostTy + ", otherManufacturingExpeFy=" + otherManufacturingExpeFy
					+ ", otherManufacturingExpeSy=" + otherManufacturingExpeSy + ", otherManufacturingExpeTy="
					+ otherManufacturingExpeTy + ", generalAndAdminExpeFy=" + generalAndAdminExpeFy
					+ ", generalAndAdminExpeSy=" + generalAndAdminExpeSy + ", generalAndAdminExpeTy="
					+ generalAndAdminExpeTy + ", sellingAndDistriExpeFy=" + sellingAndDistriExpeFy
					+ ", sellingAndDistriExpeSy=" + sellingAndDistriExpeSy + ", sellingAndDistriExpeTy="
					+ sellingAndDistriExpeTy + ", miscelExpeFy=" + miscelExpeFy + ", miscelExpeSy=" + miscelExpeSy
					+ ", miscelExpeTy=" + miscelExpeTy + ", lessExpeCapitaFy=" + lessExpeCapitaFy
					+ ", lessExpeCapitaSy=" + lessExpeCapitaSy + ", lessExpeCapitaTy=" + lessExpeCapitaTy
					+ ", totalExpenditureFy=" + totalExpenditureFy + ", totalExpenditureSy=" + totalExpenditureSy
					+ ", totalExpenditureTy=" + totalExpenditureTy + ", operatingProfitExclOiFy="
					+ operatingProfitExclOiFy + ", operatingProfitExclOiSy=" + operatingProfitExclOiSy
					+ ", operatingProfitExclOiTy=" + operatingProfitExclOiTy + ", otherIncomeFy=" + otherIncomeFy
					+ ", otherIncomeSy=" + otherIncomeSy + ", otherIncomeTy=" + otherIncomeTy
					+ ", operatingProfitEbitadOiFy=" + operatingProfitEbitadOiFy + ", operatingProfitEbitadOiSy="
					+ operatingProfitEbitadOiSy + ", operatingProfitEbitadOiTy=" + operatingProfitEbitadOiTy
					+ ", interestFy=" + interestFy + ", interestSy=" + interestSy + ", interestTy=" + interestTy
					+ ", pbdtFy=" + pbdtFy + ", pbdtSy=" + pbdtSy + ", pbdtTy=" + pbdtTy + ", depriciationFy="
					+ depriciationFy + ", depriciationSy=" + depriciationSy + ", depriciationTy=" + depriciationTy
					+ ", profitBeforeTaxationFy=" + profitBeforeTaxationFy + ", profitBeforeTaxationSy="
					+ profitBeforeTaxationSy + ", profitBeforeTaxationTy=" + profitBeforeTaxationTy
					+ ", exceptionalIncomeFy=" + exceptionalIncomeFy + ", exceptionalIncomeSy=" + exceptionalIncomeSy
					+ ", exceptionalIncomeTy=" + exceptionalIncomeTy + ", profitBeforeTaxFy=" + profitBeforeTaxFy
					+ ", profitBeforeTaxSy=" + profitBeforeTaxSy + ", profitBeforeTaxTy=" + profitBeforeTaxTy
					+ ", provisionForTaxFy=" + provisionForTaxFy + ", provisionForTaxSy=" + provisionForTaxSy
					+ ", provisionForTaxTy=" + provisionForTaxTy + ", profitAfterTaxFy=" + profitAfterTaxFy
					+ ", profitAfterTaxSy=" + profitAfterTaxSy + ", profitAfterTaxTy=" + profitAfterTaxTy
					+ ", dividendPayOutFy=" + dividendPayOutFy + ", dividendPayOutSy=" + dividendPayOutSy
					+ ", dividendPayOutTy=" + dividendPayOutTy + ", equityDividendFy=" + equityDividendFy
					+ ", equityDividendSy=" + equityDividendSy + ", equityDividendTy=" + equityDividendTy
					+ ", earningPerShareFy=" + earningPerShareFy + ", earningPerShareSy=" + earningPerShareSy
					+ ", earningPerShareTy=" + earningPerShareTy + ", shareCapitalFy=" + shareCapitalFy
					+ ", shareCapitalSy=" + shareCapitalSy + ", shareCapitalTy=" + shareCapitalTy
					...
					+ ", quickRatioSSy=" + quickRatioSSy + ", quickRatioTTy=" + quickRatioTTy + ", cashInterestCoverFy="
					+ cashInterestCoverFy + ", cashInterestCoverSy=" + cashInterestCoverSy + ", debtEbitadFy="
					+ debtEbitadFy + ", debtEbitadSy=" + debtEbitadSy + ", debtEbitadTy=" + debtEbitadTy
					+ ", freeReserveEquityFy=" + freeReserveEquityFy + ", freeReserveEquitySy=" + freeReserveEquitySy
					+ ", freeReserveEquityTy=" + freeReserveEquityTy + ", cfoMargineFy=" + cfoMargineFy
					+ ", cfoMargineSy=" + cfoMargineSy + ", growthCfoMargineFy=" + growthCfoMargineFy
