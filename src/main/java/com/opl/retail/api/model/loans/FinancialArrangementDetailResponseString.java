...
public class FinancialArrangementDetailResponseString implements Serializable{
   ...
   /* private String lenderType;*/
	...
	private String loanOwnerShipType;
	...
	public String getLoanOwnerShipType() {
		return loanOwnerShipType;
	}

	public void setLoanOwnerShipType(String loanOwnerShipType) {
		this.loanOwnerShipType = loanOwnerShipType;
	}
