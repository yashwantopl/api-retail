 ...
 *
 */
package com.opl.retail.api.model.gst.util;
...
import com.opl.retail.api.model.gst.Gstr4CalculationResponse;
import com.opl.retail.api.model.gst.Gstr4PopUpResponse;
import com.opl.retail.api.model.gst.Gstr4QoqSales;
import com.opl.retail.api.model.gst.karza.CptySum;
import com.opl.retail.api.model.gst.karza.CptySumGstr2a;
import com.opl.retail.api.model.gst.karza.Details;
import com.opl.retail.api.model.gst.karza.DetailsGstr2a;
import com.opl.retail.api.model.gst.karza.Gstr3Details;
import com.opl.retail.api.model.gst.karza.InvGstr2A;
import com.opl.retail.api.model.gst.karza.KarzaGstResponse;
import com.opl.retail.api.model.gst.karza.SecSum;
import com.opl.retail.api.model.gst.karza.SecSumGstr2a;
import com.opl.retail.api.model.gst.karza.UinDetails;
import com.opl.retail.api.model.gst.karza.UnregDetails;
import com.opl.retail.api.model.gst.model.DataMapping;
import com.opl.retail.api.model.gst.model.DataMappingProjectedSales;
import com.opl.retail.api.model.gst.model.GstCalcMappingTable;
import com.opl.retail.api.model.gst.model.ProjectedSalesCalcResponse;
import com.opl.retail.api.model.gst.model.SummOfHsn;
import com.opl.retail.api.model.gst.yuva.request.GSTR1Request;
import com.opl.retail.api.model.gst.yuva.response.gstr1cdnrinvoices.Cdnr;
import com.opl.retail.api.model.gst.yuva.response.gstr1cdnrinvoices.GSTR1CDNRInvoicesResponse;
import com.opl.retail.api.model.gst.yuva.response.gstr1cdnurinvoices.Cdnur;
import com.opl.retail.api.model.gst.yuva.response.gstr1cdnurinvoices.GSTR1CDNURInvoicesResponse;
import com.opl.retail.api.model.gst.yuva.response.gstr1hsnsummary.Data;
import com.opl.retail.api.model.gst.yuva.response.gstr1hsnsummary.Gstr1HsnSummaryResponse;
import com.opl.retail.api.model.gst.yuva.response.gstr1summary.Gstr1SummaryResponse;
import com.opl.retail.api.model.gst.yuva.response.gstr2ab2b.B2b;
import com.opl.retail.api.model.gst.yuva.response.gstr2ab2b.Gstr2AB2b;
import com.opl.retail.api.model.gst.yuva.response.gstr2ab2b.Inv;
import com.opl.retail.api.model.gst.yuva.response.gstr2ab2b.Itms;
import com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Cdn;
import com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Gstr2ACdn;
import com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Nt;
import com.opl.retail.api.model.gst.yuva.response.gstr2hsnsummary.Det;
import com.opl.retail.api.model.gst.yuva.response.gstr2hsnsummary.Gstr2HsnSummaryResponse;
import com.opl.retail.api.model.gst.yuva.response.gstr2summary.GSTR2SummaryResponse;
import com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.GSTR3BSummary;
import com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.PdCash;
import com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.TxPmt;
import com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.TxPy;
	...
	public static Map<String, Double> generation(Gstr1SummaryResponse[] resp) {
		...
		for (Gstr1SummaryResponse response : resp) {
			if (response.getSecSum() != null) {
				for (com.opl.retail.api.model.gst.yuva.response.gstr1summary.SecSum secSum : response.getSecSum()) {
					if (secSum.getCptySum() != null && "B2B".equals(secSum.getSecNm())) {
						for (com.opl.retail.api.model.gst.yuva.response.gstr1summary.CptySum cptySum : secSum
								.getCptySum()) {
...
//            }
	...
	public static Map<String, Map<String, Double>> generateDetailsCalcForB2B(Gstr1SummaryResponse rsp) {
		...
		if (rsp != null && rsp.getSecSum() != null) {
			for (com.opl.retail.api.model.gst.yuva.response.gstr1summary.SecSum secSum : rsp.getSecSum()) {
				if (PropertyMapping.B2B.equals(secSum.getSecNm()) && secSum.getCptySum() != null) {
					for (com.opl.retail.api.model.gst.yuva.response.gstr1summary.CptySum cptySum : secSum.getCptySum()) {
	...
	private static void addValue(Map<String, Object> countValueMap, Cdn cdn, String type) {
		...
		for (Nt nt : nts) {
			if (type.equals(nt.getNtty())) {
				for (com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Itms itm : nt.getItms()) {
	...
	private static void addValue(Map<String, Object> countValueMap, CptySumGstr2a cptySum, String type) {
		...
		com.opl.retail.api.model.gst.karza.Nt[] nts = cptySum.getNt();
		for (com.opl.retail.api.model.gst.karza.Nt nt : nts) {
			if (type.equals(nt.getNtty())) {
				cgst += nt.getCamt();
				igst += nt.getIamt();
				sgst += nt.getSamt();
	...
	private static void updateCDNRValue(List<Map<String, Object>> stringObjectListMap,
			com.opl.retail.api.model.gst.yuva.response.gstr1summary.CptySum cptySum) {
		...
		for (Map.Entry<String, Map<String, Map<String, Object>>> ctinRetPrirodMapEntry : retPrirodNTTypeMap
			...
			for (Map.Entry<String, Map<String, Object>> mapEntry : ctinRetPrirodMapEntry.getValue().entrySet()) {
				...
				for (Nt nt : nts) {
					...
					Double cgst = 0.0;
					Double cess = 0.0;
					com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Itms[] items = nt.getItms();
					for (com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Itms itm : items) {
						igst += itm.getItm_det().getIamt();
						sgst += itm.getItm_det().getSamt();
						cgst += itm.getItm_det().getCamt();
						cess += itm.getItm_det().getCsamt();
...
//                rec+=itm.getItm_det().getRt();
	...
	static void addValues(Map<String, Map<String, Map<String, Map<String, Object>>>> stringObjectMap2, Cdn cdn,
		...
		for (Nt nt : nts) {
			...
			Double cess = 0.0;
			for (Nt inv : invs) {
				com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Itms[] items = inv.getItms();
				for (com.opl.retail.api.model.gst.yuva.response.gstr2acdn.Itms itm : items) {
					igst += itm.getItm_det().getIamt();
					sgst += itm.getItm_det().getSamt();
					cgst += itm.getItm_det().getCamt();
...
//                rec+=itm.getItm_det().getRt();
	...
	public static void addValuesFor3bSuppMadeUnregPer(GSTR3BSummary rsp, List<Map<String, Object>> m_ttl) {
		if (rsp.getInterSup() != null && rsp.getInterSup().getUnregDetails() != null
				&& rsp.getInterSup().getUnregDetails().length > 0) {
			// m_ttl.put(TTL_VAL, rsp.getSupDetails().getOsupNongst().getTxval());
			for (com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.UnregDetails unReg : rsp.getInterSup()
					.getUnregDetails()) {
				Map<String, Object> m = new HashMap<String, Object>();
				m.put(IAMT, unReg.getIamt());
				m.put(TXVAL, unReg.getTxval());
	...
	public static void addValuesFor3bSuppMadeUinHolder(GSTR3BSummary rsp, List<Map<String, Object>> m_ttl) {
		if (rsp.getInterSup() != null && rsp.getInterSup().getUinDetails() != null
				&& rsp.getInterSup().getUinDetails().length > 0) {
			// m_ttl.put(TTL_VAL, rsp.getSupDetails().getOsupNongst().getTxval());
			for (com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.UinDetails uinDelt : rsp.getInterSup()
					.getUinDetails()) {
				Map<String, Object> m = new HashMap<String, Object>();
				m.put(IAMT, uinDelt.getIamt());
				m.put(TXVAL, uinDelt.getTxval());
	...
	public static void addValuesFor3bGstExempt(Gstr3Details rsp, List<Map<String, Object>> m_ttl) {
		if (rsp.getInwardSup() != null && rsp.getInwardSup().getIsupDetails() != null
			...
			// m_ttl.put(TTL_VAL, rsp.getSupDetails().getOsupNongst().getTxval());
			for (com.opl.retail.api.model.gst.karza.IsupDetails uinDelt : rsp.getInwardSup().getIsupDetails()) {
				Map<String, Object> m = new HashMap<String, Object>();
	...
	public static void addValuesFor3bGstExempt(GSTR3BSummary rsp, List<Map<String, Object>> m_ttl) {
		if (rsp.getInwardSup() != null && rsp.getInwardSup().getIsupDetails() != null
				&& rsp.getInwardSup().getIsupDetails().length > 0) {
			// m_ttl.put(TTL_VAL, rsp.getSupDetails().getOsupNongst().getTxval());
			for (com.opl.retail.api.model.gst.yuva.response.gstr3bsummary.IsupDetails uinDelt : rsp.getInwardSup()
					.getIsupDetails()) {
				Map<String, Object> m = new HashMap<String, Object>();
				m.put("inter", uinDelt.getInter());
				m.put("intra", uinDelt.getIntra());
	...
	private static Double addValue(Cdnr cdnr, String type) {
		Double val = 0.0;
		com.opl.retail.api.model.gst.yuva.response.gstr1cdnrinvoices.Nt[] nts = cdnr.getNt();
		for (com.opl.retail.api.model.gst.yuva.response.gstr1cdnrinvoices.Nt nt : nts) {
