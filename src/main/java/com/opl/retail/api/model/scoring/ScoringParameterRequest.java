...
public class ScoringParameterRequest {
	...
	private Boolean haveCollateralSecurity = false;
	private List<String> collateralSecurityList;
	...
	public List<String> getCollateralSecurityList() {
		return collateralSecurityList;
	}

	public void setCollateralSecurityList(List<String> collateralSecurityList) {
