...
public class ProposalScoreResponse {
 ...
 /**
	...
	/**
	 * @param subScoringType the subScoringType to set
	 */
...
/**
	...
	// FINAL CONCESSION pf new
    private Double finalMaxConcessionRateOfInterestConcessPf;
    private String concessionBasedOnTypeConcessPf;
    
    
    
    
	/**
	 * @return the finalMaxConcessionRateOfInterestConcessPf
	 */
	public Double getFinalMaxConcessionRateOfInterestConcessPf() {
		return finalMaxConcessionRateOfInterestConcessPf;
	}

	/**
	 * @return the concessionBasedOnTypeConcessPf
	 */
	public String getConcessionBasedOnTypeConcessPf() {
		return concessionBasedOnTypeConcessPf;
	}

	/**
	 * @param finalMaxConcessionRateOfInterestConcessPf the finalMaxConcessionRateOfInterestConcessPf to set
	 */
	public void setFinalMaxConcessionRateOfInterestConcessPf(Double finalMaxConcessionRateOfInterestConcessPf) {
		this.finalMaxConcessionRateOfInterestConcessPf = finalMaxConcessionRateOfInterestConcessPf;
	}

	/**
	 * @param concessionBasedOnTypeConcessPf the concessionBasedOnTypeConcessPf to set
	 */
	public void setConcessionBasedOnTypeConcessPf(String concessionBasedOnTypeConcessPf) {
		this.concessionBasedOnTypeConcessPf = concessionBasedOnTypeConcessPf;
	}
