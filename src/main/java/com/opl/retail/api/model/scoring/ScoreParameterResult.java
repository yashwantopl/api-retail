...
public class ScoreParameterResult {
    ...
    private String min_bank_relationship_msme_text;
    private String min_bank_relationship_msme_code;
    private Double min_bank_relationship_msme_score;
    private Double min_bank_relationship_msme_max_score;

    private String collateral_security_msme_text;
    private String collateral_security_msme_code;
    private Double collateral_security_msme_score;
    private Double collateral_security_msme_max_score;


    public String getMin_bank_relationship_msme_text() {
        return min_bank_relationship_msme_text;
    }

    public void setMin_bank_relationship_msme_text(String min_bank_relationship_msme_text) {
        this.min_bank_relationship_msme_text = min_bank_relationship_msme_text;
    }

    public String getMin_bank_relationship_msme_code() {
        return min_bank_relationship_msme_code;
    }

    public void setMin_bank_relationship_msme_code(String min_bank_relationship_msme_code) {
        this.min_bank_relationship_msme_code = min_bank_relationship_msme_code;
    }

    public Double getMin_bank_relationship_msme_score() {
        return min_bank_relationship_msme_score;
    }

    public void setMin_bank_relationship_msme_score(Double min_bank_relationship_msme_score) {
        this.min_bank_relationship_msme_score = min_bank_relationship_msme_score;
    }

    public Double getMin_bank_relationship_msme_max_score() {
        return min_bank_relationship_msme_max_score;
    }

    public void setMin_bank_relationship_msme_max_score(Double min_bank_relationship_msme_max_score) {
        this.min_bank_relationship_msme_max_score = min_bank_relationship_msme_max_score;
    }

    public String getCollateral_security_msme_text() {
        return collateral_security_msme_text;
    }

    public void setCollateral_security_msme_text(String collateral_security_msme_text) {
        this.collateral_security_msme_text = collateral_security_msme_text;
    }

    public String getCollateral_security_msme_code() {
        return collateral_security_msme_code;
    }

    public void setCollateral_security_msme_code(String collateral_security_msme_code) {
        this.collateral_security_msme_code = collateral_security_msme_code;
    }

    public Double getCollateral_security_msme_score() {
        return collateral_security_msme_score;
    }

    public void setCollateral_security_msme_score(Double collateral_security_msme_score) {
        this.collateral_security_msme_score = collateral_security_msme_score;
    }

    public Double getCollateral_security_msme_max_score() {
        return collateral_security_msme_max_score;
    }

    public void setCollateral_security_msme_max_score(Double collateral_security_msme_max_score) {
        this.collateral_security_msme_max_score = collateral_security_msme_max_score;
    }
