...
public class FitchOutputServ {
	...
	public String toString() {
		return "FitchOutputServ{" +
				...
				", companyRiskGrade='" + companyRiskGrade + '\'' +
				", finalRiscScore=" + finalRiscScore +
				", finalRiskWeight=" + finalRiskWeight +
				", businessRiskScore=" + businessRiskScore +
				", businessRiskWeight=" + businessRiskWeight +
				", managementRiskScore=" + managementRiskScore +
				", managementRiskWeight=" + managementRiskWeight +
				", industryRiskScore=" + industryRiskScore +
				", industryRiskWeight=" + industryRiskWeight +
				", basicRiskScore=" + basicRiskScore +
				", conductAccountRiskFactor=" + conductAccountRiskFactor +
				", conductAccountRiskScore=" + conductAccountRiskScore +
				", adjustedRiskScore=" + adjustedRiskScore +
				", finalRiskGrade='" + finalRiskGrade + '\'' +
				", keyObservationsOne='" + keyObservationsOne + '\'' +
				", keyObservationsTwo='" + keyObservationsTwo + '\'' +
				", keyObservationsThree='" + keyObservationsThree + '\'' +
				", keyObservationsFour='" + keyObservationsFour + '\'' +
				", keyObservationsFive='" + keyObservationsFive + '\'' +
				", keyObservationsSix='" + keyObservationsSix + '\'' +
				", keyObservationsSeven='" + keyObservationsSeven + '\'' +
				", keyObservationsEight='" + keyObservationsEight + '\'' +
				", keyObservationsNine='" + keyObservationsNine + '\'' +
				", ebitadNetSaleScore=" + ebitadNetSaleScore +
				", ebitadNetSaleWeight=" + ebitadNetSaleWeight +
				", interestCoverageScore=" + interestCoverageScore +
				", interestCoverageWeight=" + interestCoverageWeight +
				", roceScore=" + roceScore +
				", roceWeight=" + roceWeight +
				", salesGrowthScore=" + salesGrowthScore +
				", salesGrowthWeight=" + salesGrowthWeight +
				", tolTnwScore=" + tolTnwScore +
				", tolTnwWeight=" + tolTnwWeight +
				", nwcEbitadScore=" + nwcEbitadScore +
				", nwcEbitadWeight=" + nwcEbitadWeight +
				", sumNotchDownsScore=" + sumNotchDownsScore +
				", basicFinancialScore=" + basicFinancialScore +
				", accountingQualityScore=" + accountingQualityScore +
				", contingentLiabilityNWScore=" + contingentLiabilityNWScore +
				", financialScore=" + financialScore +
				", customerQualityAndConcentrationScore=" + customerQualityAndConcentrationScore +
				...
				", productSeasonalityScore=" + productSeasonalityScore +
				", productSeasonalityWeight=" + productSeasonalityWeight +
				", impactOnOperatingMarginsScore=" + impactOnOperatingMarginsScore +
				", impactOnOperatingMarginsWeight=" + impactOnOperatingMarginsWeight +
				", environmentalImpactScore=" + environmentalImpactScore +
				", environmentalImpactWeight=" + environmentalImpactWeight +
				", integrityScore=" + integrityScore +
				", integrityWeight=" + integrityWeight +
				", businessCommitmentScore=" + businessCommitmentScore +
				", businessCommitmentWeight=" + businessCommitmentWeight +
				", managementCompetenceScore=" + managementCompetenceScore +
				", managementCompetenceWeight=" + managementCompetenceWeight +
				", businessExperienceScore=" + businessExperienceScore +
				", businessExperienceWeight=" + businessExperienceWeight +
				", successionPlanningScore=" + successionPlanningScore +
				", successionPlanningWeight=" + successionPlanningWeight +
				", financialStrengthScore=" + financialStrengthScore +
				", financialStrengthWeight=" + financialStrengthWeight +
				", internalControlScore=" + internalControlScore +
				", internalControlWeight=" + internalControlWeight +
				", creditTrackRecordScore=" + creditTrackRecordScore +
				", creditTrackRecordWeight=" + creditTrackRecordWeight +
				", capForTurnover=" + capForTurnover +
				", capOnCreditTrackRecord=" + capOnCreditTrackRecord +
				", capForEnvironment=" + capForEnvironment +
				", capForSuccessionPlanning=" + capForSuccessionPlanning +
				", capForFinancialRatios=" + capForFinancialRatios +
				", chequesBillsReturnedNumber=" + chequesBillsReturnedNumber +
				", dpLimitOverDrawnNumber=" + dpLimitOverDrawnNumber +
				", cumulativeDPLimitOverdrawnNumberDays=" + cumulativeDPLimitOverdrawnNumberDays +
				", complianceSanctionedDisbursementConditions=" + complianceSanctionedDisbursementConditions +
				", submissionProgressReports=" + submissionProgressReports +
				", delayReceiptPrincipalInterestInstalments=" + delayReceiptPrincipalInterestInstalments +
				", delayInSubmissionAuditedBSAndPL=" + delayInSubmissionAuditedBSAndPL +
				", varianceInProjectedSalesVersusActualSales=" + varianceInProjectedSalesVersusActualSales +
				", lcBgIssuedInFavorBorrowerInvoked=" + lcBgIssuedInFavorBorrowerInvoked +
				'}';
	}
}
