...
public class WorkingCapitalParameterRequestNewStructure extends ProductMasterRequestNewStructure implements Serializable {
  ...
  //co-origination new parameter
	...
	private List<String> constitutionList = Collections.emptyList();
	...
	public WorkingCapitalParameterRequestNewStructure() {
	...
	public void setConstitutionList(List<String> constitutionList) {
		this.constitutionList = constitutionList;
	}
}
