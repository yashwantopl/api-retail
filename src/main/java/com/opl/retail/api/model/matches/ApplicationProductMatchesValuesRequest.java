...
public class ApplicationProductMatchesValuesRequest implements Serializable {
	...
	private Boolean isDebtEquityWithoutMatch;
	private String debtEquityWithoutValFS;
	private String debtEquityWithoutValMinFP;
	private String debtEquityWithoutValMaxFP;
	...
	public Boolean getIsDebtEquityWithoutMatch() {
		return isDebtEquityWithoutMatch;
	}

	public void setIsDebtEquityWithoutMatch(Boolean isDebtEquityWithoutMatch) {
		this.isDebtEquityWithoutMatch = isDebtEquityWithoutMatch;
	}

	public String getDebtEquityWithoutValFS() {
		return debtEquityWithoutValFS;
	}

	public void setDebtEquityWithoutValFS(String debtEquityWithoutValFS) {
		this.debtEquityWithoutValFS = debtEquityWithoutValFS;
	}

	public String getDebtEquityWithoutValMinFP() {
		return debtEquityWithoutValMinFP;
	}

	public void setDebtEquityWithoutValMinFP(String debtEquityWithoutValMinFP) {
		this.debtEquityWithoutValMinFP = debtEquityWithoutValMinFP;
	}

	public String getDebtEquityWithoutValMaxFP() {
		return debtEquityWithoutValMaxFP;
	}

	public void setDebtEquityWithoutValMaxFP(String debtEquityWithoutValMaxFP) {
		this.debtEquityWithoutValMaxFP = debtEquityWithoutValMaxFP;
	}
