...
public class OutputSheetServ {
	...
	private Double riskScoreAdjforCOA;
	...
	public Double getConductACRiskScore() {
		return conductACRiskScore;
	}

	public void setConductACRiskScore(Double conductACRiskScore) {
		this.conductACRiskScore = conductACRiskScore;
	}

	public Double getCaRiskFactor() {
		return caRiskFactor;
	}
	...
	public Double getRiskScoreAdjforCOA() {
		return riskScoreAdjforCOA;
	}

	public void setRiskScoreAdjforCOA(Double riskScoreAdjforCOA) {
		this.riskScoreAdjforCOA = riskScoreAdjforCOA;
	}
	...
	public String toString() {
		return "OutputSheetServ [ebitadNetSaleScore=" + ebitadNetSaleScore + ", ebitadNetSaleWeight="
				...
				+ ", tolTnwScore=" + tolTnwScore + ", tolTnwWeight=" + tolTnwWeight + ", nwcEbitadScore="
				+ nwcEbitadScore + ", nwcEbitadWeight=" + nwcEbitadWeight + ", basicFinancialScore="
				+ basicFinancialScore + ", accountingQualityScore=" + accountingQualityScore
				+ ", contingentLiabilityNWScore=" + contingentLiabilityNWScore + ", sumNotchDownsScore="
				+ sumNotchDownsScore + ", financialScore=" + financialScore + ", financialWeight=" + financialWeight
				+ ", chequesBillsReturnedNumber=" + chequesBillsReturnedNumber + ", dpLimitOverDrawnNumber="
				+ dpLimitOverDrawnNumber + ", cumulativeDPLimitOverdrawnNumberDays="
				+ cumulativeDPLimitOverdrawnNumberDays + ", complianceSanctionedDisbursementConditions="
				+ complianceSanctionedDisbursementConditions + ", submissionProgressReports="
				+ submissionProgressReports + ", delayReceiptPrincipalInterestInstalments="
				+ delayReceiptPrincipalInterestInstalments + ", delayInSubmissionAuditedBSAndPL="
				...
				+ ", sustainabilityProductDemandScore=" + sustainabilityProductDemandScore
				+ ", sustainabilityProductDemandWeight=" + sustainabilityProductDemandWeight
				+ ", productSeasonalityScore=" + productSeasonalityScore + ", productSeasonalityWeight="
				+ productSeasonalityWeight + ", impactOnOperatingMarginsScore=" + impactOnOperatingMarginsScore
				+ ", impactOnOperatingMarginsWeight=" + impactOnOperatingMarginsWeight + ", environmentalImpactScore="
				+ environmentalImpactScore + ", environmentalImpactWeight=" + environmentalImpactWeight
				+ ", businessRiskScore=" + businessRiskScore + ", businessRiskWeight=" + businessRiskWeight
				+ ", integrityScore=" + integrityScore + ", integrityWeight=" + integrityWeight
				...
				+ ", successionPlanningScore=" + successionPlanningScore + ", successionPlanningWeight="
				+ successionPlanningWeight + ", financialStrengthScore=" + financialStrengthScore
				+ ", financialStrengthWeight=" + financialStrengthWeight + ", internalControlScore="
				+ internalControlScore + ", internalControlWeight=" + internalControlWeight
				+ ", creditTrackRecordScore=" + creditTrackRecordScore + ", creditTrackRecordWeight="
				+ creditTrackRecordWeight + ", managementRiskScore=" + managementRiskScore + ", managementRiskWeight="
				+ managementRiskWeight + ", basicRiskScore=" + basicRiskScore + ", riskScoreAdjforCOA="
				+ riskScoreAdjforCOA + ", capForTurnover=" + capForTurnover + ", capOnCreditTrackRecord="
				+ capOnCreditTrackRecord + ", capForEnvironment=" + capForEnvironment + ", capForSuccessionPlanning="
				+ capForSuccessionPlanning + ", capForFinancialRatios=" + capForFinancialRatios + ", finalRiskGrade="
				+ finalRiskGrade + ", irr=" + irr + ", keyObservationsOne=" + keyObservationsOne
				+ ", keyObservationsTwo=" + keyObservationsTwo + ", keyObservationsThree=" + keyObservationsThree
				+ ", keyObservationsFour=" + keyObservationsFour + ", keyObservationsFive=" + keyObservationsFive
				+ ", keyObservationsSix=" + keyObservationsSix + ", keyObservationsSeven=" + keyObservationsSeven
				+ ", keyObservationsEight=" + keyObservationsEight + ", keyObservationsNine=" + keyObservationsNine
				+ "]";
	}
