...
public class ProposalMappingRequest implements Serializable {
    ...
    private Integer foirInRsSubType;
	...
	/**
	 * @return the foirInRsSubType
	 */
	public Integer getFoirInRsSubType() {
		return foirInRsSubType;
	}
	...
	/**
	 * @param foirInRsSubType the foirInRsSubType to set
	 */
	public void setFoirInRsSubType(Integer foirInRsSubType) {
		this.foirInRsSubType = foirInRsSubType;
	}
  ...
  public Integer getDateTypeMasterId() {
	...
	public String toString() {
		return "ProposalMappingRequest [id=" + id + ", fpProductId=" + fpProductId + ", fpProductName=" + fpProductName
				...
				+ ", consessionRoi=" + consessionRoi + ", concessionBasedOnType=" + concessionBasedOnType
				+ ", scoringModelBasedOn=" + scoringModelBasedOn + ", nbfcFlow=" + nbfcFlow + ", ratioId=" + ratioId
				+ ", pfConcession=" + pfConcession + ", pfConcessionText=" + pfConcessionText + ", connectFlowTypeId="
				+ connectFlowTypeId + ", pfConcessionTextConcessPf=" + pfConcessionTextConcessPf
				+ ", consessionRoiConcessPf=" + consessionRoiConcessPf + ", foirInRs=" + foirInRs + ", foirInRsSubType="
				+ foirInRsSubType + ", consessionBasedOnSalaryAccount=" + consessionBasedOnSalaryAccount + "]";
	}
}
