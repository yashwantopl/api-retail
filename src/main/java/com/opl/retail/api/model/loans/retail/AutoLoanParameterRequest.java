...
import com.opl.retail.api.model.loans.LoanPurposeAmountMappingRequest;
...
public class AutoLoanParameterRequest extends RetailProduct implements Serializable {
	...
	private Boolean isMaxExShowroomPrice;
	...
	private Boolean isCoAppIncomeForEligibilityCalc = false;
	...
	public Boolean getIsCoAppIncomeForEligibilityCalc() {
		return isCoAppIncomeForEligibilityCalc;
	}

	public void setIsCoAppIncomeForEligibilityCalc(Boolean coAppIncomeForEligibilityCalc) {
	...
	public Boolean getIsMaxExShowroomPrice() {
		return isMaxExShowroomPrice;
	}

	public void setIsMaxExShowroomPrice(Boolean maxExShowroomPrice) {
		isMaxExShowroomPrice = maxExShowroomPrice;
	}
}