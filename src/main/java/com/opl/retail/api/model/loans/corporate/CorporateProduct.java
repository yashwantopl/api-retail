...
public class CorporateProduct extends ProductMasterRequest implements Serializable {
	...
	private Boolean isDebtEquityWithoutDisplay=false;

	private Boolean isDebtEquityWithoutMandatory=false;
	
	private BigDecimal maxDebtEquityWithout;
	
	private BigDecimal minDebtEquityWithout;
	...
	public Boolean getIsDebtEquityWithoutDisplay() {
		return isDebtEquityWithoutDisplay;
	}

	public void setIsDebtEquityWithoutDisplay(Boolean isDebtEquityWithoutDisplay) {
		this.isDebtEquityWithoutDisplay = isDebtEquityWithoutDisplay;
	}

	public Boolean getIsDebtEquityWithoutMandatory() {
		return isDebtEquityWithoutMandatory;
	}

	public void setIsDebtEquityWithoutMandatory(Boolean isDebtEquityWithoutMandatory) {
		this.isDebtEquityWithoutMandatory = isDebtEquityWithoutMandatory;
	}

	public BigDecimal getMaxDebtEquityWithout() {
		return maxDebtEquityWithout;
	}

	public void setMaxDebtEquityWithout(BigDecimal maxDebtEquityWithout) {
		this.maxDebtEquityWithout = maxDebtEquityWithout;
	}

	public BigDecimal getMinDebtEquityWithout() {
		return minDebtEquityWithout;
	}

	public void setMinDebtEquityWithout(BigDecimal minDebtEquityWithout) {
		this.minDebtEquityWithout = minDebtEquityWithout;
	}
