...
//
	...
	public String toString() {
		return "ScoreParameterRetailRequest [isWorkingExperience_p=" + isWorkingExperience_p
				...
				+ isBorrowerMargin_p + ", isAdhaarCard_p=" + isAdhaarCard_p + ", isVehicleAge_p=" + isVehicleAge_p
				+ ", workingExperience=" + workingExperience + ", elAmountOnAverageScoring=" + elAmountOnAverageScoring
				+ ", avgEodBalToToalDep=" + avgEodBalToToalDep + ", workingExperienceCurrent="
				+ workingExperienceCurrent + ", emiNmiRatio=" + emiNmiRatio + ", securityCoverage=" + securityCoverage
				+ ", takeHomePay=" + takeHomePay + ", borrowerMargin=" + borrowerMargin + ", vechileAge=" + vechileAge
				+ ", vechileType=" + vechileType + ", personalBankingRelationShip=" + personalBankingRelationShip
				...
				+ ", adhaarCardValue=" + adhaarCardValue + ", cibilScore=" + cibilScore + ", toir=" + toir + ", foir="
				+ foir + ", age=" + age + ", roi=" + roi + ", educationQualification=" + educationQualification
				+ ", employmentType=" + employmentType + ", employmentTypeCatJob=" + employmentTypeCatJob
				+ ", employmentTypeSelfEmpBus=" + employmentTypeSelfEmpBus + ", houseOwnership=" + houseOwnership
				+ ", loanPurpose=" + loanPurpose + ", loanPurposeQueType=" + loanPurposeQueType
				+ ", loanPurposeQueValue=" + loanPurposeQueValue + ", maritalStatus=" + maritalStatus
				+ ", currentEmploymentStatus=" + currentEmploymentStatus + ", categoryInfo=" + categoryInfo
				+ ", lastYearTotalIncomeFromITR=" + lastYearTotalIncomeFromITR + ", incomeFromItr=" + incomeFromItr
				+ ", emiAmountFromCIBIL=" + emiAmountFromCIBIL + ", chequeBounce=" + chequeBounce
				+ ", chequeBouncelast1Month=" + chequeBouncelast1Month + ", avgOfTotalCheDepsitLast6Month="
				+ avgOfTotalCheDepsitLast6Month + ", dpd=" + dpd + ", netAnnualIncome=" + netAnnualIncome
				+ ", noOfDependants=" + noOfDependants + ", emi=" + emi + ", nmi=" + nmi + ", gmi=" + gmi + ", ltv="
				+ ltv + ", netWorth=" + netWorth + ", noOfYearCurrentLocation=" + noOfYearCurrentLocation
				+ ", marketValueOfProp=" + marketValueOfProp + ", spouseEmploymentDetails=" + spouseEmploymentDetails
				+ ", numberOfDependents=" + numberOfDependents + ", ageOfProperty=" + ageOfProperty
				+ ", noOfApplicantsType=" + noOfApplicantsType + ", residenceType=" + residenceType
				+ ", repaymentPeriod=" + repaymentPeriod + ", designation=" + designation + ", loanToIncomeRatio="
				+ loanToIncomeRatio + ", loanAmtProposed=" + loanAmtProposed + ", grossAnnualIncome="
				+ grossAnnualIncome + ", availableIncome=" + availableIncome + ", spouseIncome=" + spouseIncome
				+ ", eligibleTenure=" + eligibleTenure + ", loanPurposeModelId=" + loanPurposeModelId
				+ ", netWrothToLoanAmount=" + netWrothToLoanAmount + ", avgEODBal=" + avgEODBal + ", deposite="
				+ deposite + ", eligibleLoanAmountCircular=" + eligibleLoanAmountCircular + ", exitingLoanObligation="
				+ exitingLoanObligation + ", tenureOfTheLoan=" + tenureOfTheLoan + ", exShowRoomPrice="
				+ exShowRoomPrice + ", onRoadPrice=" + onRoadPrice + ", agreedIDV=" + agreedIDV + ", repaymentMode="
				+ repaymentMode + ", isPurReadyBuiltHouse=" + isPurReadyBuiltHouse
				...
				+ ", cibilActualScore=" + cibilActualScore + ", cibilActualScoreVersion2=" + cibilActualScoreVersion2
				+ ", accountType=" + accountType + ", isBorrowersHavingAccountsConcessPf="
				...
				+ ", isNoCreaditHistoryConcessPf=" + isNoCreaditHistoryConcessPf + "]";
	}
