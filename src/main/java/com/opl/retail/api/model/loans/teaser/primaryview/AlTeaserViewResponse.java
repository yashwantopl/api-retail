...
import com.opl.retail.api.model.loans.GuarantorsCorporateDetailRequest;
...
import com.opl.retail.api.model.loans.retail.ALOneformPrimaryRes;
...
public class AlTeaserViewResponse {
	...
	private Boolean isCoAppIncomeForEligibilityCalc;
	private Boolean isCoAppOthThnSalIncomeForEligibilityCalc;
	private Long userId;
	...
	private Object dealerDetail;
	
	private String pfConcessionTextConcessPf;
	
	private Double consessionRoiConcessPf; 
	
	private Double consessionBasedOnSalaryAccount;
	...
	public Boolean getCoAppIncomeForEligibilityCalc() {
		return isCoAppIncomeForEligibilityCalc;
	}
	public void setCoAppIncomeForEligibilityCalc(Boolean coAppIncomeForEligibilityCalc) {
		isCoAppIncomeForEligibilityCalc = coAppIncomeForEligibilityCalc;
	}
	public Boolean getCoAppOthThnSalIncomeForEligibilityCalc() {
		return isCoAppOthThnSalIncomeForEligibilityCalc;
	}
	public void setCoAppOthThnSalIncomeForEligibilityCalc(Boolean coAppOthThnSalIncomeForEligibilityCalc) {
	...
	public Object getDealerDetail() {
		return dealerDetail;
	}

	public void setDealerDetail(Object dealerDetail) {
		this.dealerDetail = dealerDetail;
	}

	public String getPfConcessionTextConcessPf() {
		return pfConcessionTextConcessPf;
	}

	public void setPfConcessionTextConcessPf(String pfConcessionTextConcessPf) {
		this.pfConcessionTextConcessPf = pfConcessionTextConcessPf;
	}

	public Double getConsessionRoiConcessPf() {
		return consessionRoiConcessPf;
	}

	public void setConsessionRoiConcessPf(Double consessionRoiConcessPf) {
		this.consessionRoiConcessPf = consessionRoiConcessPf;
	}

	public Double getConsessionBasedOnSalaryAccount() {
		return consessionBasedOnSalaryAccount;
	}

	public void setConsessionBasedOnSalaryAccount(Double consessionBasedOnSalaryAccount) {
		this.consessionBasedOnSalaryAccount = consessionBasedOnSalaryAccount;
	}
