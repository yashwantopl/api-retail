...
public enum ConnectStage {
	...
	ODOP_LOAN_IS_ELIGIBLE(2200, "ODOP LOAN IS ELIGIBLE"),
	ODOP_DIRECTOR_BACKGROUND_BUSINESS_DETAIL(2201, "ODOP DIRECTOR BACKGROUND BUSINESS DETAIL"),
	ODOP_DIRECTOR_BACKGROUND_APPLICANT_DETAILS(2202, "ODOP DIRECTOR BACKGROUND APPLICANT DETAILS"),
	ODOP_DIRECTOR_BACKGROUND_ASSOCIATE_CONCERN_DETAIL(2203, "ODOP DIRECTOR BACKGROUND ASSOCIATE CONCERN DETAIL"),
	ODOP_ONE_FORM(2204, "ODOP ONE FORM"),
    ODOP_MATCHES(2205, "ODOP MATCHES"),
    ODOP_PAYMENT(2206, "ODOP PAYMENT"),
    ODOP_IN_PRINCIPLE(2207, "ODOP IN PRINCIPLE"),
    ODOP_COMPLETE(2208, "ODOP COMPLETE"),

    DFS_MCQ(3000, "DFS MCQ"),
    DFS_GST(3001, "DFS GST"),
    DFS_ITR(3002, "DFS ITR"),
    DFS_BANK_STATEMENT(3003, "DFS BANK STATEMENT"),
    DFS_DIRECTOR_BACKGROUND(3004, "DFS DIRECTOR BACKGROUND"),
    DFS_ONE_FORM(3005, "DFS ONE FORM"),
    DFS_MATCHES(3006, "DFS MATCHES"),
    DFS_PAYMENT(3007, "DFS PAYMENT"),
    DFS_IN_PRINCIPLE(3008, "DFS IN PRINCIPLE"),
    DFS_COMPLETE(3009, "DFS COMPLETE");
