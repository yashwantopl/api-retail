package com.opl.retail.api.utils.eligibility;
...
public class EligibilityUtils {
   ...
   public static final List<String> URLS_BRFORE_LOGIN  = new ArrayList<String>(8);
	...
	public final class EligibilityType {
		...
		public static final int BASED_ON_INCOME = 1;
		public static final int BASED_ON_INCOME_MULTIPLIER = 2;
	...
	public final class EmployementType {
	...
	public final class EmployementTypeForPL {
		private EmployementTypeForPL(){}

		public static final int SALARIED = 1;
		public static final int PENSIONER = 2;
	}

	public final class EmployerConstitution {
	...
	public final class ReceiptMode {
		private ReceiptMode(){}
	...
	public final class Occupation {
		...
		public static final int SELF_EMPLOYED_PROFESSIONAL = 5;
		public static final int AGRICULTURIST = 6;
		public static final int PENSIONER = 7;
	}

	public final class HomeLoanPurpose {
		private HomeLoanPurpose(){}

		public static final int PURCHASE_OF_READY_FLAT_TENAMENT_ROW_HOUSE = 3;
		public static final int CONSTRUCTION_OF_BUNGLOW_TENAMENT = 4;
		public static final int REPAIRING_RENOVATION_OF_FLAT_TENAMENT = 5;
		public static final int PURCHASE_OF_PLOT = 6;
	}
}
