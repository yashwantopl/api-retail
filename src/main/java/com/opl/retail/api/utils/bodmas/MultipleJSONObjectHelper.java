...
public class MultipleJSONObjectHelper implements Serializable {
	...
	public  static Map<String, Object> getMapFromString(String theStringToParse) throws IOException {
		final ObjectMapper mapper = new ObjectMapper();
		return mapper.readValue(theStringToParse, new TypeReference<Map<String, Object>>() {});
	}
