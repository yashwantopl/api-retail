...
public class MatchConstant {
	...
	//Cash Profit Growth % (Y-o-Y) 
		public  static final class CashProfitYearType
	    {
	    	private CashProfitYearType()
			{
				// nothing.
			}
	    	public static final Integer CASH_PROFIT_GROWTH_ONEYEAR=1;
	    	public static final Integer CASH_PROFIT_GROWTH_TWOYEAR=2;
	    }
}
