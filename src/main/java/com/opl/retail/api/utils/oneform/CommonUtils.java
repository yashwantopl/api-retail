...
public class CommonUtils {
	...
	private static final List<CommonUtils.EnumsClassName> MASTER_DATA =  new ArrayList<CommonUtils.EnumsClassName>();

	public static List<CommonUtils.EnumsClassName> getMasterData(){
		return MASTER_DATA;
	}
	static{
	...
	public static boolean isObjectNullOrEmpty(Object value) {
		return (value == null
				|| (value instanceof String && (((String) value).isEmpty() || "".equals(((String) value).trim()) || "null".equals(value)
